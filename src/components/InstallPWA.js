	...
	return (
		...
		{mobilePwa &&
			<div className="mobile-pwa">
				<div style={{padding: "15px 35px", color: "#fff"}} >For the best user experience we recommended install the TubeVideos app. Click the <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
