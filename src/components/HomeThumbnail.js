  ...
  return (
    <>
      <div id="video-thumb">
        {videoThumb}
        {loadingRedtube ? (
          <div className="loading-animation" style={{ height: "auto" }}>
        ...
        {loadingBabestation ? (
          <div
            ...
            style={{ height: "auto", marginBottom: "3rem" }}
          >
            <div className="loading-spinner"></div>
          </div>
        ) : (
      ...
      {!isEnd && videoThumb && (
        <div className="more-btn">
          <button name="more" className="type-bg" onClick={onChangeHandleMore}>
            Load more
          </button>
        </div>
      )}
